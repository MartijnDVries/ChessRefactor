...
class GetSquares(metaclass=Singleton):
    ...
    def knight_squares_from(self, square):
        squares = []
        square = self.positionHandler.getSquareFromIndex(square)
        ...
        squares = [self.positionHandler.getSquareIndex(square) for square in squares]
...
if __name__ == "__main__":
    ...
    for square in get.pawn_capture_squares_from(E7, 'BLACK'):
        print(s.getSquareFromIndex(square))
